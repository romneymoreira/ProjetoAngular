(function () {
    ...
    ListarUsuario.$inject = ['$scope', '$http', '$q', '$modal', 'DTOptionsBuilder', 'blockUI', 'common', 'notification', 'ds.seguranca'];

    function ListarUsuario($scope, $http, $q, $modal, DTOptionsBuilder, blockUI, common, notification, dsSeguranca) {
        ...
        function desativar(id) {
            ...
            notification.ask(vm.askOptions, function (confirm) {
                ...
                if (confirm) {
                    var blocker = blockUI.instances.get('blockModalListaFor');
                    blocker.start();
                    dsSeguranca.desativarUsuario(id).then(function (result) {
        ...
        function resetar(id) {
            ...
            notification.ask(vm.askOptions, function (confirm) {
                ...
                if (confirm) {
                    var blocker = blockUI.instances.get('blockModalListaFor');
                    blocker.start();
                    dsSeguranca.resetarSenha(id).then(function (result) {
                        notification.showSuccessBar("Alteração realizada com sucesso");
                        init();
                    })
                    .catch(function (ex) {
        ...
        function ativar(id) {
            ...
            notification.ask(vm.askOptions, function (confirm) {
                ...
                if (confirm) {
                    var blocker = blockUI.instances.get('blockModalListaFor');
                    blocker.start();
                    dsSeguranca.ativarUsuario(id).then(function (result) {
                        notification.showSuccessBar("Alteração realizada com sucesso");
                        init();
                    })
                    .catch(function (ex) {
        ...
        function excluir(id) {
            ...
            notification.ask(vm.askOptions, function (confirm) {
                if (confirm) {
                    ...
                    var blocker = blockUI.instances.get('blockModalListaFor');
                    blocker.start();
                    dsSeguranca.excluirUsuario(id).then(function (result) {
