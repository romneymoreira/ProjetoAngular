(function () {
    ...
    angular
        .module('app.pessoa')
        .controller('PessoaCrudController', PessoaCrudController);

    PessoaCrudController.$inject = ['$scope', '$http', '$q', '$modal', '$modalInstance', 'blockUI', 'common', 'notification', 'pacienteservice', 'cadastroservice', 'comumservice', 'id'];

    function PessoaCrudController($scope, $http, $q, $modal, $modalInstance, blockUI, common, notification, pacienteservice, cadastroservice, comumservice, id) {

        var vm = this;
        vm.State = "Incluir Pessoa";
        vm.FormMessage = "";
