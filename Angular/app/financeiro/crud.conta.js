(function () {
    ...
    ContaCrud.$inject = ['$scope', '$http', '$modal', '$modalInstance', 'blockUI', 'common', 'notification', 'ds.financeiro', 'id'];

    function ContaCrud($scope, $http, $modal, $modalInstance, blockUI, common, notification, dsFinanceiro, id) {
