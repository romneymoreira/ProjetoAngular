(function () {
    ...
    Transferencias.$inject = ['$scope', '$http', '$q', '$modal', 'DTOptionsBuilder', 'blockUI', 'common', 'notification', 'ds.financeiro', '$stateParams'];
    function Transferencias($scope, $http, $q, $modal, DTOptionsBuilder, blockUI, common, notification, dsFinanceiro, $stateParams) {
        var vm = this;
