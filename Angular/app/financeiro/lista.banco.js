(function () {
    ...
    Bancos.$inject = ['$scope', '$http', '$q', '$modal', 'DTOptionsBuilder', 'blockUI', 'common', 'notification', 'ds.financeiro', '$stateParams'];
    function Bancos($scope, $http, $q, $modal, DTOptionsBuilder, blockUI, common, notification, dsFinanceiro, $stateParams) {
        var vm = this;
