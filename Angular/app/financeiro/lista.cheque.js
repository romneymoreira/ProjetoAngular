(function () {
    ...
    Cheques.$inject = ['$scope', '$http', '$q', '$modal', 'DTOptionsBuilder', 'blockUI', 'common', 'notification', 'ds.financeiro', '$stateParams'];
    function Cheques($scope, $http, $q, $modal, DTOptionsBuilder, blockUI, common, notification, dsFinanceiro, $stateParams) {
        var vm = this;
        //vm.pesq = [];
