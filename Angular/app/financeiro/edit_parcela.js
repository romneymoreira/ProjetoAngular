(function () {
    ...
    EditarParcela.$inject = ['$scope', '$state', '$http', '$q', 'blockUI', 'common', '$modal', '$modalInstance', 'notification', 'ds.financeiro','tipo', 'idparcela','idfinanceiro'];
    function EditarParcela($scope, $state, $http, $q, blockUI, common, $modal, $modalInstance, notification, dsFinanceiro,tipo, idparcela,idfinanceiro) {
        var vm = this;
        ...
        function init() {
            ...
            var pMeios = dsFinanceiro.listarmeiospagamento();
