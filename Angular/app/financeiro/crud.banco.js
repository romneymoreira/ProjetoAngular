(function () {
    ...
    BancoCrud.$inject = ['$scope', '$http', '$modal', '$modalInstance', 'blockUI', 'common', 'notification', 'ds.financeiro', 'id'];

    function BancoCrud($scope, $http, $modal, $modalInstance, blockUI, common, notification, dsFinanceiro, id) {
