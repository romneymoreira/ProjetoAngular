 (function () {
    ...
    PlanoContas.$inject = ['$scope', '$http', '$q', '$modal', 'DTOptionsBuilder', 'blockUI', 'common', 'notification', 'ds.financeiro', '$stateParams'];
    function PlanoContas($scope, $http, $q, $modal, DTOptionsBuilder, blockUI, common, notification, dsFinanceiro, $stateParams) {
        var vm = this;
        ...
        function excluirPlanoConta(id) {
            ...
            notification.ask(vm.askOptions, function (confirm) {
                if (confirm) {
                    ...
                    var blocker = blockUI.instances.get('blockModalListaFor');
                    blocker.start();
                    dsFinanceiro.excluirPlanoConta(id).then(function (result) {
