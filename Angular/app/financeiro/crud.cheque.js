(function () {
    ...
    ChequeCrud.$inject = ['$scope', '$http', '$q', '$modal', '$modalInstance', 'blockUI', 'common', 'notification', 'ds.financeiro', 'id'];

    function ChequeCrud($scope, $http, $q, $modal, $modalInstance, blockUI, common, notification, dsFinanceiro, id) {
        ...
        function init() {
            vm.FormMessage = "";
            var pBancos = dsFinanceiro.listarbancos();
