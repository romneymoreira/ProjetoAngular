(function () {
    ...
    FinanceiroController.$inject = ['$scope', '$state', '$http', '$q', '$modal', 'DTOptionsBuilder', 'blockUI', 'common', 'notification', 'ds.financeiro', '$stateParams'];
    function FinanceiroController($scope, $state, $http, $q, $modal, DTOptionsBuilder, blockUI, common, notification, dsFinanceiro, $stateParams) {
        var vm = this;
