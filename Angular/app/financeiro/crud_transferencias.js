(function () {
    ...
    CrudTransferencias.$inject = ['$scope', '$state', '$http', '$q', '$http', '$modal', '$modalInstance', 'blockUI', 'common', 'notification', 'ds.financeiro', 'id'];
    function CrudTransferencias($scope, $state, $http, $q, $modal, $modalInstance, blockUI, common, notification, dsFinanceiro, id) {
        var vm = this;
