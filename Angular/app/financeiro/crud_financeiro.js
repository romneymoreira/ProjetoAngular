(function () {
    ...
    CrudFinanceiro.$inject = ['$scope', '$state', '$http', '$q', '$modal','$modalInstance', 'blockUI', 'common', 'notification', 'ds.financeiro', 'tipo'];

    function CrudFinanceiro($scope, $state, $http, $q, $modal, $modalInstance, blockUI, common, notification, dsFinanceiro, tipo) {
        var vm = this;
        ...
        function getpessoa() {
            ...
            modalInstance.result.then(function (item) {
                ...
                vm.idpessoaSelecionada = item.IdPaciente;
